			...
			<div className="center cursor-pointer" >
					...
					<div className="additional">
						<div className="user-card">
							...
							>
								...
								<desc id="desc">
									Cartoon of a Caucasian woman smiling, and wearing black glasses and a purple shirt with white collar drawn by
									Alvaro Montoro.
								</desc>
              ...
              <div className="points ">5,312 Points</div>
					...
					<div className="general">
						<h1>Jane Doe</h1>
						<p>
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce a volutpat mauris, at molestie lacus. Nam vestibulum
							sodales odio ut pulvinar.
						</p>
